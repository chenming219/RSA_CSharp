...
namespace CSInteropKeys
{
  class AsnKeyBuilder
  {
    ...
    internal static AsnMessage PublicKeyToPKCS1(RSAParameters publicKey)
    {
        // Value Type cannot be null
        // Debug.Assert(null != publicKey);
        ...
        * */
        ...
        return new AsnMessage(key.GetBytes(), "PKCS#1");
    }
    ...
    internal static AsnMessage PrivateKeyToPKCS1(RSAParameters privateKey)
    {
        // Value Type cannot be null
        // Debug.Assert(null != privateKey);
